    ...
    render: function () {
        return (
            React.createElement("div", null, 
                React.createElement(PanelHeaderComponent, {text: "Car Details"}), 
                React.createElement("h3", null, this.state.car.type, " ", this.state.car.make), 
                this.state.car.title
            )
        );
    }
});
},{"./panel-header-component.jsx":161,"react":157}],159:[function(require,module,exports){
var React = require('react');
var $ = require('jquery');
...
},{"jquery":2,"react":157}],160:[function(require,module,exports){
var React = require('react');
var PanelHeaderComponent =  require('./panel-header-component.jsx');
    ...
    render: function () {
        return (
            React.createElement("div", {className: "panel"}, 
                React.createElement(PanelHeaderComponent, {text: "Car Inventory"}), 
                React.createElement(PanelSearchComponent, {searchHandler: this.searchHandler}), 
                React.createElement(PanelList, {cars: this.state.cars})
            )
        );
    }
});

},{"./panel-header-component.jsx":161,"./panel-list-component.jsx":162,"./panel-search-component.jsx":164,"react":157}],161:[function(require,module,exports){
var React = require('react');
...
module.exports = React.createClass({
    ...
    render: function () {
        var items = this.props.cars.map(function (car) {
            return (
                React.createElement(PanelListItem, {key: car.id, car: car})
            );
        });
        return (
...
},{"./panel-list-item-component.jsx":163,"react":157}],163:[function(require,module,exports){
var React = require('react');
    ...
    render: function () {
        return (
           React.createElement("li", null, 
                React.createElement("a", {href: "#cars/" + this.props.car.id}, 
            	    React.createElement("img", {className: "", src: "img/" + this.props.car.type + ".jpg"}), 
                    React.createElement("span", {className: "vehicle"}, " ", this.props.car.type, " ", this.props.car.make)
                )
           )
        );
    }
...
module.exports = React.createClass({
    ...
    render: function () {
        return (
            React.createElement("input", {type: "search", ref: "searchKey", onChange: this.searchHandler})
        );
    }
});
...
Router.addRoute('', function() {
	React.render(
		React.createElement(PanelComponent, {service: CarService}),
		document.body
	);
});
...
Router.addRoute('cars/:id', function(id) {
    React.render(
        React.createElement(CarPage, {carId: id, service: CarService}),
        document.body
    );
});
...
Router.start();
},{"./car-details-component.jsx":158,"./data.jsx":159,"./panel-component.jsx":160,"./router.jsx":166,"react":157}],166:[function(require,module,exports){
var React = require('react');
...
},{"react":157}]},{},[158,159,160,161,162,163,164,165,166]);
